...
🔏 Edit your smart contract `AbiStore.sol` in `packages/hardhat/contracts`
...
📚 Go through each topic from [solidity by example](https://solidity-by-example.org) editing `AbiStore.sol` in **🏗 scaffold-eth**
